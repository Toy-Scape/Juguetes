...
//#define DRAW_ALTERNATIVE_PREVIEW
using System;
using UnityEngine;
using UnityEditor;
...
namespace BuildingMakerToolset.PropPlacer
{
    ...
    public class RowPropPlacerEditor : UnityEditor.Editor
    {
        ...
        {
            curRowPropPlacerTarget.ForceUpdate();
        }
        ...
        void DrawPrefabView(RowPropPlacer tgt)
        {
            ...
            RuntimePreviewGenerator.ClearPreviewScene();
        }
        ...
        static Texture2D GetIcon( GameObject asset, int width, int hight)
        {
            ...
            RuntimePreviewGenerator.BackgroundColor = new Color(0.35f, 0.35f, 0.35f);
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            BuildingUnitEditor.CheckForHierarchyConflictInSceneGUI(eventType, curRowPropPlacerTarget);
            PivotEditor( evt );
        }
        ...
        static GameObject InstantiateProp(GameObject go, RowPropPlacer spwn)
        {
            ...
            newGo.transform.localScale = BHUtilities.BMTFindUniformScale(spwn.transform.localScale);
